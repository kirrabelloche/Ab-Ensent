...
class PostController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('posts.create')->withCategories($categories)->withTags($tags)->withDepartements($depatements)->withFilieres($filieres);
    }
    ...
    public function getdeptfiliere(Request $request){
    $id=$request->input('id');
